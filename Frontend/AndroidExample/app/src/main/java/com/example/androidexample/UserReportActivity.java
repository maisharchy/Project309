...
public class UserReportActivity extends AppCompatActivity{
    ...
    private EditText reporterIDEntry, reportedIDEntry, issueEntry, bugReporterEntry;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        homeBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(UserReportActivity.this, HomeActivity.class));
            }
        });
        ...
        backBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(UserReportActivity.this, ReportActivity.class));
            }
        });
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Validate inputs
                if (reporterID.isEmpty() || reportedID.isEmpty() || issue.isEmpty()) {
        ...
        final String REQ_URL = APP_URL + "/api/complaints";
