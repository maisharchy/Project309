...
public class UpdateUserActivity extends AppCompatActivity {
        ...
        submitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!password.equals(confirm)){ // test if the password and confirm password fields match
                    ...
                    Toast.makeText(getApplicationContext(), "Updating Profile", Toast.LENGTH_LONG).show();
                }
    ...
    private void makeUpdateReq(JSONObject jsonBody) {
        final String mRequestBody = jsonBody.toString();
        final String REQ_URL = APP_URL + "/api/users/complaints{id}";
